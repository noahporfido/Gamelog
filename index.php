...
?>
    ...
    <body>
        <div id="NavTop">
            ...
            <div id="Navbuttons">
                <li> <a href='<?php echo "index.php?function=blogs&bid=$blogId"; ?>' class="Buttons">Blogs</a></li>
                <li> <a href="<?php echo "index.php?function=login&bid=$blogId"; ?>" class="Buttons">Login</a></li>
            </div>
        </div>
        <?php
